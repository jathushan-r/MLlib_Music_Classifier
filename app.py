...
def main():
    ...
    st.markdown(
        """
        Predict the genre of song lyrics using machine learning.
        
        This application classifies lyrics into one of the following genres:
        - Pop
        - Country
        - Blues
        - Rock
        ...
        If the prediction confidence is below the threshold, the genre will be marked as "Unknown".
        """
    )
    ...
    st.sidebar.info(
        """
        This app uses a machine learning model trained on a dataset of song lyrics 
        to predict the genre of input lyrics.
    ...
    # Footer
    st.sidebar.markdown("---")
    st.sidebar.markdown("© 2025 Lyrics Classifier")
